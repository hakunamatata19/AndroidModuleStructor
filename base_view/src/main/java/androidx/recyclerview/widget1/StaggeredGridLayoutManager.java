...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements
     ...
     */
    @NonNull
    androidx.recyclerview.widget1.OrientationHelper mPrimaryOrientation;
    @NonNull
    androidx.recyclerview.widget1.OrientationHelper mSecondaryOrientation;
    ...
    @NonNull
    private final androidx.recyclerview.widget1.LayoutState mLayoutState;
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mLayoutState = new androidx.recyclerview.widget1.LayoutState();
    ...
    private void createOrientationHelpers() {
        mPrimaryOrientation = androidx.recyclerview.widget1.OrientationHelper.createOrientationHelper(this, mOrientation);
        mSecondaryOrientation = androidx.recyclerview.widget1.OrientationHelper
    ...
    boolean checkForGaps() {
        ...
        int invalidGapDir = mShouldReverseLayout ? androidx.recyclerview.widget1.LayoutState.LAYOUT_START : androidx.recyclerview.widget1.LayoutState.LAYOUT_END;
    ...
    private void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        if (anchorInfo.mLayoutFromEnd) {
            // Layout start.
            setLayoutStateDirection(androidx.recyclerview.widget1.LayoutState.LAYOUT_START);
            fill(recycler, mLayoutState, state);
            // Layout end.
            setLayoutStateDirection(androidx.recyclerview.widget1.LayoutState.LAYOUT_END);
        ...
        if (mPendingSavedState == null || mPendingSavedState.mAnchorPosition == RecyclerView.NO_POSITION
            ...
            if (child != null) {
                ...
                if (mPendingScrollPositionOffset == INVALID_OFFSET) {
                    ...
                    anchorInfo.mLayoutFromEnd = position == androidx.recyclerview.widget1.LayoutState.LAYOUT_END;
                    anchorInfo.assignCoordinateFromPadding();
                } else {
    ...
    private void setLayoutStateDirection(int direction) {
        ...
        mLayoutState.mItemDirection = (mShouldReverseLayout == (direction == androidx.recyclerview.widget1.LayoutState.LAYOUT_START))
                ? androidx.recyclerview.widget1.LayoutState.ITEM_DIRECTION_TAIL : androidx.recyclerview.widget1.LayoutState.ITEM_DIRECTION_HEAD;
    }
    ...
    public void onItemsRemoved(RecyclerView recyclerView, int positionStart, int itemCount) {
        handleUpdate(positionStart, itemCount, androidx.recyclerview.widget1.AdapterHelper.UpdateOp.REMOVE);
    }

    @Override
    public void onItemsAdded(RecyclerView recyclerView, int positionStart, int itemCount) {
        handleUpdate(positionStart, itemCount, androidx.recyclerview.widget1.AdapterHelper.UpdateOp.ADD);
    }
    ...
    public void onItemsMoved(RecyclerView recyclerView, int from, int to, int itemCount) {
        handleUpdate(from, to, androidx.recyclerview.widget1.AdapterHelper.UpdateOp.MOVE);
    }

    @Override
    public void onItemsUpdated(RecyclerView recyclerView, int positionStart, int itemCount,
                               Object payload) {
        handleUpdate(positionStart, itemCount, androidx.recyclerview.widget1.AdapterHelper.UpdateOp.UPDATE);
    }
    ...
    private void handleUpdate(int positionStart, int itemCountOrToPosition, int cmd) {
        ...
        if (cmd == androidx.recyclerview.widget1.AdapterHelper.UpdateOp.MOVE) {
        ...
        switch (cmd) {
            case androidx.recyclerview.widget1.AdapterHelper.UpdateOp.ADD:
                mLazySpanLookup.offsetForAddition(positionStart, itemCountOrToPosition);
                break;
            case androidx.recyclerview.widget1.AdapterHelper.UpdateOp.REMOVE:
                mLazySpanLookup.offsetForRemoval(positionStart, itemCountOrToPosition);
                break;
            case androidx.recyclerview.widget1.AdapterHelper.UpdateOp.MOVE:
                // TODO optimize
    ...
    private int fill(RecyclerView.Recycler recycler, androidx.recyclerview.widget1.LayoutState layoutState,
                     RecyclerView.State state) {
        ...
        if (mLayoutState.mInfinite) {
            if (layoutState.mLayoutDirection == androidx.recyclerview.widget1.LayoutState.LAYOUT_END) {
        ...
        while (layoutState.hasMore(state)
            ...
            if (layoutState.mLayoutDirection == androidx.recyclerview.widget1.LayoutState.LAYOUT_END) {
                ...
                if (assignSpan && lp.mFullSpan) {
                    ...
                    fullSpanItem.mGapDir = androidx.recyclerview.widget1.LayoutState.LAYOUT_START;
                ...
                if (assignSpan && lp.mFullSpan) {
                    ...
                    fullSpanItem.mGapDir = androidx.recyclerview.widget1.LayoutState.LAYOUT_END;
                    fullSpanItem.mPosition = position;
                    mLazySpanLookup.addFullSpanItem(fullSpanItem);
                }
            }
            ...
            if (lp.mFullSpan && layoutState.mItemDirection == androidx.recyclerview.widget1.LayoutState.ITEM_DIRECTION_HEAD) {
                if (assignSpan) {
        ...
        final int diff;
        if (mLayoutState.mLayoutDirection == androidx.recyclerview.widget1.LayoutState.LAYOUT_START) {
    ...
    private void attachViewToSpans(View view, LayoutParams lp, androidx.recyclerview.widget1.LayoutState layoutState) {
        if (layoutState.mLayoutDirection == androidx.recyclerview.widget1.LayoutState.LAYOUT_END) {
            if (lp.mFullSpan) {
    ...
    private void recycle(RecyclerView.Recycler recycler, androidx.recyclerview.widget1.LayoutState layoutState) {
        if (!layoutState.mRecycle || layoutState.mInfinite) {
            return;
        }
        if (layoutState.mAvailable == 0) {
            // easy, recycle line is still valid
            if (layoutState.mLayoutDirection == androidx.recyclerview.widget1.LayoutState.LAYOUT_START) {
    ...
    private void updateRemainingSpans(Span span, int layoutDir, int targetLine) {
        ...
        if (layoutDir == androidx.recyclerview.widget1.LayoutState.LAYOUT_START) {
    ...
    private boolean preferLastSpan(int layoutDir) {
        if (mOrientation == HORIZONTAL) {
            return (layoutDir == androidx.recyclerview.widget1.LayoutState.LAYOUT_START) != mShouldReverseLayout;
        }
        return ((layoutDir == androidx.recyclerview.widget1.LayoutState.LAYOUT_START) == mShouldReverseLayout) == isLayoutRTL();
    }

    /**
     * Finds the span for the next view.
     */
    private Span getNextSpan(androidx.recyclerview.widget1.LayoutState layoutState) {
    ...
    private int calculateScrollDirectionForPosition(int position) {
        if (getChildCount() == 0) {
            return mShouldReverseLayout ? androidx.recyclerview.widget1.LayoutState.LAYOUT_END : androidx.recyclerview.widget1.LayoutState.LAYOUT_START;
        }
        final int firstChildPos = getFirstChildPosition();
        return position < firstChildPos != mShouldReverseLayout ? androidx.recyclerview.widget1.LayoutState.LAYOUT_START : androidx.recyclerview.widget1.LayoutState.LAYOUT_END;
    }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state,
                                       int position) {
        androidx.recyclerview.widget1.LinearSmoothScroller scroller = new LinearSmoothScroller(recyclerView.getContext());
    ...
    public void collectAdjacentPrefetchPositions(int dx, int dy, RecyclerView.State state,
        ...
        for (int i = 0; i < mSpanCount; i++) {
            ...
            int distance = mLayoutState.mItemDirection == androidx.recyclerview.widget1.LayoutState.LAYOUT_START
    ...
    void prepareLayoutStateForDelta(int delta, RecyclerView.State state) {
        ...
        if (delta > 0) { // layout towards end
            layoutDir = androidx.recyclerview.widget1.LayoutState.LAYOUT_END;
            referenceChildPosition = getLastChildPosition();
        } else {
            layoutDir = androidx.recyclerview.widget1.LayoutState.LAYOUT_START;
    ...
    public View onFocusSearchFailed(View focused, int direction, RecyclerView.Recycler recycler,
        ...
        if (layoutDir == androidx.recyclerview.widget1.LayoutState.INVALID_LAYOUT) {
            return null;
        }
        ...
        final int referenceChildPosition;
        if (layoutDir == androidx.recyclerview.widget1.LayoutState.LAYOUT_END) { // layout towards end
            referenceChildPosition = getLastChildPosition();
        } else {
            referenceChildPosition = getFirstChildPosition();
        }
        ...
        boolean shouldSearchFromStart = !mReverseLayout == (layoutDir == androidx.recyclerview.widget1.LayoutState.LAYOUT_START);
     ...
     * @return {@link androidx.recyclerview.widget1.LayoutState#LAYOUT_START} or {@link androidx.recyclerview.widget1.LayoutState#LAYOUT_END} if focus direction
     * is applicable to current state, {@link androidx.recyclerview.widget1.LayoutState#INVALID_LAYOUT} otherwise.
     */
    private int convertFocusDirectionToLayoutDirection(int focusDirection) {
        switch (focusDirection) {
            case View.FOCUS_BACKWARD:
                if (mOrientation == VERTICAL) {
                    return androidx.recyclerview.widget1.LayoutState.LAYOUT_START;
                } else if (isLayoutRTL()) {
                    return androidx.recyclerview.widget1.LayoutState.LAYOUT_END;
                } else {
                    return androidx.recyclerview.widget1.LayoutState.LAYOUT_START;
                }
            ...
            case View.FOCUS_UP:
                return mOrientation == VERTICAL ? androidx.recyclerview.widget1.LayoutState.LAYOUT_START
                        : androidx.recyclerview.widget1.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_DOWN:
                return mOrientation == VERTICAL ? androidx.recyclerview.widget1.LayoutState.LAYOUT_END
                        : androidx.recyclerview.widget1.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_LEFT:
                return mOrientation == HORIZONTAL ? androidx.recyclerview.widget1.LayoutState.LAYOUT_START
                        : androidx.recyclerview.widget1.LayoutState.INVALID_LAYOUT;
            case View.FOCUS_RIGHT:
                return mOrientation == HORIZONTAL ? androidx.recyclerview.widget1.LayoutState.LAYOUT_END
                        : androidx.recyclerview.widget1.LayoutState.INVALID_LAYOUT;
            default:
                if (DEBUG) {
                    Log.d(TAG, "Unknown focus request:" + focusDirection);
                }
                return androidx.recyclerview.widget1.LayoutState.INVALID_LAYOUT;
        }
    ...
    class Span {
        ...
        void calculateCachedStart() {
            ...
            if (lp.mFullSpan) {
                ...
                if (fsi != null && fsi.mGapDir == androidx.recyclerview.widget1.LayoutState.LAYOUT_START) {
        ...
        void calculateCachedEnd() {
            ...
            if (lp.mFullSpan) {
                LazySpanLookup.FullSpanItem fsi = mLazySpanLookup
                        .getFullSpanItem(lp.getViewLayoutPosition());
                if (fsi != null && fsi.mGapDir == androidx.recyclerview.widget1.LayoutState.LAYOUT_END) {
