 ...
 * <p>
 * At minimum, defines item diffing behavior with a {@link androidx.recyclerview.widget1.DiffUtil.ItemCallback}, used to compute
...
public final class AsyncDifferConfig<T> {
    ...
    @NonNull
    private final androidx.recyclerview.widget1.DiffUtil.ItemCallback<T> mDiffCallback;
    ...
    @SuppressWarnings("WeakerAccess")
    @NonNull
    public androidx.recyclerview.widget1.DiffUtil.ItemCallback<T> getDiffCallback() {
