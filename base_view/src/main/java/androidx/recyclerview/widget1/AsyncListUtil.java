...
public class AsyncListUtil<T> {
    ...
    final androidx.recyclerview.widget1.TileList<T> mTileList;

    final androidx.recyclerview.widget1.ThreadUtil.MainThreadCallback<T> mMainThreadProxy;
    final androidx.recyclerview.widget1.ThreadUtil.BackgroundCallback<T> mBackgroundProxy;
    ...
    public AsyncListUtil(@NonNull Class<T> klass, int tileSize,
        ...
        mTileList = new androidx.recyclerview.widget1.TileList<T>(mTileSize);

        androidx.recyclerview.widget1.ThreadUtil<T> threadUtil = new androidx.recyclerview.widget1.MessageThreadUtil<T>();
    ...
    private final androidx.recyclerview.widget1.ThreadUtil.MainThreadCallback<T>
            mMainThreadCallback = new androidx.recyclerview.widget1.ThreadUtil.MainThreadCallback<T>() {
        @Override
        ...
        @Override
        public void addTile(int generation, androidx.recyclerview.widget1.TileList.Tile<T> tile) {
            if (!isRequestedGeneration(generation)) {
                if (DEBUG) {
            ...
            androidx.recyclerview.widget1.TileList.Tile<T> duplicate = mTileList.addOrReplace(tile);
            if (duplicate != null) {
        ...
        public void removeTile(int generation, int position) {
            ...
            androidx.recyclerview.widget1.TileList.Tile<T> tile = mTileList.removeAtPos(position);
            if (tile == null) {
    ...
    private final androidx.recyclerview.widget1.ThreadUtil.BackgroundCallback<T>
            mBackgroundCallback = new androidx.recyclerview.widget1.ThreadUtil.BackgroundCallback<T>() {

        private androidx.recyclerview.widget1.TileList.Tile<T> mRecycledRoot;
        ...
        public void loadTile(int position, int scrollHint) {
            ...
            androidx.recyclerview.widget1.TileList.Tile<T> tile = acquireTile();
        ...
        @Override
        public void recycleTile(androidx.recyclerview.widget1.TileList.Tile<T> tile) {
            if (DEBUG) {
        ...
        private androidx.recyclerview.widget1.TileList.Tile<T> acquireTile() {
            if (mRecycledRoot != null) {
                androidx.recyclerview.widget1.TileList.Tile<T> result = mRecycledRoot;
                mRecycledRoot = mRecycledRoot.mNext;
                return result;
            }
            return new androidx.recyclerview.widget1.TileList.Tile<T>(mTClass, mTileSize);
        }
        ...
        private void addTile(androidx.recyclerview.widget1.TileList.Tile<T> tile) {
