...
/**
 * Helper for computing the difference between two lists via {@link androidx.recyclerview.widget1.DiffUtil} on a background
 * thread.
 * <p>
 ...
 * data simply for an adapter. It computes differences in list contents via {@link androidx.recyclerview.widget1.DiffUtil} on a
 ...
 *
 * @see androidx.recyclerview.widget1.DiffUtil
 * @see androidx.recyclerview.widget1.AdapterListUpdateCallback
 */
public class AsyncListDiffer<T> {
    private final androidx.recyclerview.widget1.ListUpdateCallback mUpdateCallback;
    @SuppressWarnings("WeakerAccess") /* synthetic access */
    final androidx.recyclerview.widget1.AsyncDifferConfig<T> mConfig;
    @SuppressWarnings("WeakerAccess") /* synthetic access */
     ...
     *
     * @see androidx.recyclerview.widget1.DiffUtil.DiffResult#dispatchUpdatesTo(RecyclerView.Adapter)
     */
    public AsyncListDiffer(@NonNull RecyclerView.Adapter adapter,
            @NonNull androidx.recyclerview.widget1.DiffUtil.ItemCallback<T> diffCallback) {
        this(new AdapterListUpdateCallback(adapter),
            new androidx.recyclerview.widget1.AsyncDifferConfig.Builder<>(diffCallback).build());
    }
    ...
    public AsyncListDiffer(@NonNull androidx.recyclerview.widget1.ListUpdateCallback listUpdateCallback,
    ...
    public void submitList(@Nullable final List<T> newList) {
        ...
        mConfig.getBackgroundThreadExecutor().execute(new Runnable() {
            @Override
            public void run() {
                final androidx.recyclerview.widget1.DiffUtil.DiffResult result = androidx.recyclerview.widget1.DiffUtil.calculateDiff(new androidx.recyclerview.widget1.DiffUtil.Callback() {
                    @Override
