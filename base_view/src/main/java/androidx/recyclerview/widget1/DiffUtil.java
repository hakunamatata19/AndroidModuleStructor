 ...
 * <p>
 * It can be used to calculate updates for a RecyclerView Adapter. See {@link androidx.recyclerview.widget1.ListAdapter} and
...
public class DiffUtil {
     ...
     * {@link #dispatchUpdatesTo(androidx.recyclerview.widget1.ListUpdateCallback)} or directly stream the results into a
    ...
    public static class DiffResult {
         ...
         * {@link RecyclerView.AdapterDataObserver AdapterDataObserver},
         * you can use
         * {@link #dispatchUpdatesTo(androidx.recyclerview.widget1.ListUpdateCallback)} to handle each modification
         * manually.
         *
         ...
         */
        public void dispatchUpdatesTo(@NonNull androidx.recyclerview.widget1.ListUpdateCallback updateCallback) {
        ...
        private void dispatchAdditions(List<PostponedUpdate> postponedUpdates,
                                       androidx.recyclerview.widget1.ListUpdateCallback updateCallback, int start, int count, int globalIndex) {
            if (!mDetectMoves) {
