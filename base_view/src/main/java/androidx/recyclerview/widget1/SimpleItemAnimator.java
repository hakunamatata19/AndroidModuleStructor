 ...
 * API.
 * <p>
 * It uses {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo} to track the bounds information of the Views. If you would like
 * to
 * extend this class, you can override {@link #obtainHolderInfo()} method to provide your own info
 * class that extends {@link androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo}.
 */
