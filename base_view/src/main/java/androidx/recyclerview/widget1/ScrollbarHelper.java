...
class ScrollbarHelper {
     ...
     */
    static int computeScrollOffset(RecyclerView.State state, androidx.recyclerview.widget1.OrientationHelper orientation,
     ...
     * @param endChild   View closest to end of the list (bottom or right)
     */
    static int computeScrollExtent(RecyclerView.State state, androidx.recyclerview.widget1.OrientationHelper orientation,
                                   View startChild, View endChild, RecyclerView.LayoutManager lm,
