...
public class SortedList<T> {
    ...
    /**
     * Replaces the current items with the new items, dispatching {@link androidx.recyclerview.widget1.ListUpdateCallback} events
     ...
     * {@link androidx.recyclerview.widget1.ListUpdateCallback#onMoved(int, int)} events. It instead treats moves as a remove
     * followed by an add and therefore dispatches {@link androidx.recyclerview.widget1.ListUpdateCallback#onRemoved(int, int)}
     * and {@link androidx.recyclerview.widget1.ListUpdateCallback#onRemoved(int, int)} events.  See {@link DiffUtil} if you want
