...
/**
 * Wraps a {@link androidx.recyclerview.widget1.ListUpdateCallback} callback and batches operations that can be merged.
 * <p>
 ...
 */
public class BatchingListUpdateCallback implements androidx.recyclerview.widget1.ListUpdateCallback {
    private static final int TYPE_NONE = 0;
    private static final int TYPE_ADD = 1;
    private static final int TYPE_REMOVE = 2;
    private static final int TYPE_CHANGE = 3;

    final androidx.recyclerview.widget1.ListUpdateCallback mWrapped;
