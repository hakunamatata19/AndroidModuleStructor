...
/**
 * Precompiled java-library-convention script plugin.
 **/
public class JavaLibraryConventionPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_JavaLibraryConvention").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_JavaLibraryConvention").asSubclass(BasicScript.class);
